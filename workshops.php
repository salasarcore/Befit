    ...
    <div class="container">
		<div class="row">
			...
			<div class="content">
				...
				<p><ul>
			<li>
				Kettle Bells workshop</li>
			<li>
				Yoga</li>
			<li>
				1 minute recipes</li>
			<li>
				Weight loss nutrition</li>
			<li>
				Weight gain nutrition</li>
			<li>
				Pedi nutrition</li>
			<li>
				Weight loss nutrition recipe</li>
			<li>
				Weight gain nutrition recipe</li>
			<li>
				Fitness evaluation</li>
			<li>
				Body status workshop</li>
		</ul>
</p>
			</div>
			</div>
