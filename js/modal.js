...
loadveil:function(){
	...
	this.interVeil.style.height="789px" //set up veil over page
...
dhtmlwindow.addEvent(window, function(){if (typeof dhtmlmodal!="undefined") dhtmlmodal.adjustveil()}, "resize")
 ...
 function open_modal(url,width,height,title)
  {
	//url="ajaxbid_tender_confirm.php?tid=<?php echo base64_encode($tid);?>&act=<?php echo base64_encode("save");?>&Tlotid="+document.getElementById('Tlotid').value+"&bType="+document.getElementById('bType').value+"&clientBid="+document.getElementById('clientBid').value;
	emailwindow=dhtmlmodal.open('EmailBox', 'iframe', url, title, 'width='+width+',height='+height+',center=1,resize=0,scrolling=1')
