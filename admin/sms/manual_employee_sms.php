...
if(in_array(module_manual_employee_sms,$modules)){
	$id_admin=$_SESSION['empid'];
	$level=$_SESSION['access_level'];
	if($level!='Super Admin' && $level!='Admin')
	{
		if(!isAccessModule($id_admin, module_manual_employee_sms))
		{
...
function ActionScript(act)
{
     ...
     if($.trim(checkValues)==""){
	    ...
	    url="sms/popups/send_employee_sms.php?act="+act+"&values="+checkValues;
		open_modal(url,620,420,"MANUAL EMPLOYEE SMS")
		return true;
     }
}
...
<div class="page_head">
<div id="navigation"><a href="pages.php">Home</a><a> Utilities</a><a> SMS</a> <span style="color: #000000;"> Employee SMS</span> </div>

<form name="myForm" id="myForm" action="pages.php?src=sms/manual_employee_sms.php" method="POST">

<table width="100%">
<tr><td><h2>Employee Manual SMS</h2></td>
	<td>
	<div id="option_menu">
