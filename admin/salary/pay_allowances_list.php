...
?>
<div class="page_head">
<div id="navigation"><a href="pages.php">Home</a><a> Payroll</a>  <span style="color: #000000;">Pay & Allowances List(All Branch)</span></div>

<form name="records" action="pages.php?src=salary/pay_allowances_list.php" method="POST" onsubmit="return validatefilter();">
...
Pay & Allowances Name :<input type="text" name="txtFilter" id="txtFilter" /> <input type="submit" name="btnGo" class="btn btn-info" value="Go">
</div>
<br />
